...
func TestLoadReadsRequiredAndOptionalValues(t *testing.T) {
	...
	want := Config{ExpensesTable: "expenses", ExpenseDetailsTable: "expense-details", MonthlySummariesTable: "monthly-summaries", JWTSecretParameter: "/dev/jwt", Stage: "dev", LogLevel: "debug"}
	if cfg != want {
